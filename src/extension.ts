    ...
    async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
      ...
      return {
        ...
        details: {
          ...
          ...(metadata?.phaseHint ? { phaseHint: metadata.phaseHint } : {}),
        },
      };
    },
  });
